...
class login:
	def __init__(self,root):
		...
		#############Clock!!!!!!!!!!!!!!!!!
		self.label=Label(root,font=('Ds-Digital',20,'bold'),bg ='light blue',fg='Black')
		self.label.place(x=795,y=0)
		string=strftime('Time : %H:%M:%S:%p \nDate : %D')
		self.label.config(text=string)
		self.label.after(1000,login)
	...
	def Login(self):
		...
		#@@@@@@@@@@@Bg Image
					self.bg=ImageTk.PhotoImage(file='5.jpg')
		...
		#=====left image===
					self.left=PhotoImage(file='11.PNG')
		...
		#!!!!!!!!!!!!!!!!!!!11111111111111111111111111111111111111111111111111111111111111111111111111111111
					#############Clock!!!!!!!!!!!!!!!!!
					self.label1=Label(frame1,font=('Ds-Digital',20,'bold'),bg ='light gray',fg='Black')
					self.label1.place(x=390,y=0)
					string=strftime('Time : %H:%M:%S:%p \nDate : %D')
					self.label1.config(text=string)
					self.label1.after(1000,login)
	...
	def forget(self):
		...
		messagebox.showinfo('Information', 'Welcome!\n You Have To Contact Developer....To Recover Your Password!!', parent=self.root)
		#pathfile='C:\\Users\\krishna\\Documents\\registration form.py'
		#os.startfile(pathfile)
